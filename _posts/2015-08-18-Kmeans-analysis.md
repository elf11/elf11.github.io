...
To further highlight the difference in service between the rural and urban communities, as well as between communities with a higher median income and those with a lower median income, we plotted the average values for RTT, upload and download (in Mb/s) for each of those clusters.

<figure class="third">
	<a href="/images/Average_MedianRTT83.png"><img src="/images/Average_MedianRTT83.png" alt=""></a>
